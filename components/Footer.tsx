    ...
    <footer className="border-t border-zinc-900 bg-black py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-5 sm:flex-row lg:px-8">
        <div className="flex items-center gap-2">
          <div className="grid h-8 w-8 place-items-center rounded-full border border-gold/40 bg-zinc-900 font-display text-lg text-gold leading-none">
            J
          </div>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="WhatsApp"
            className="text-zinc-500 transition hover:text-gold"
          >
